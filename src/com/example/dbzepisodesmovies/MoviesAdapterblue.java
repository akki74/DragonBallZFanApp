...
public class MoviesAdapterblue extends BaseExpandableListAdapter {

	private Context ctx;
	private HashMap<String, List<String>> Movies_Category;
	private List<String> Movies_List;

	public MoviesAdapterblue(Context ctx,
	...
	public View getGroupView(int parent, boolean isExpanded,
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.parent_layoutblue, parentview, false);
		}
